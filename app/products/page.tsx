...
import { getProducts, getSiteContent, type Product } from '@/lib/dataStore';
...
function ProductsList() {
    ...
    useEffect(() => {
        ...
        setSareeTypes(getSiteContent().sareeTypes);
        setLoading(false);
    }, []);
    ...
    }, [allProducts, selectedType, sortBy, minPrice, maxPrice]);

    if (loading) {
        return <div className="min-h-screen flex items-center justify-center font-serif text-heritage-maroon">Loading our collection...</div>;
    }
